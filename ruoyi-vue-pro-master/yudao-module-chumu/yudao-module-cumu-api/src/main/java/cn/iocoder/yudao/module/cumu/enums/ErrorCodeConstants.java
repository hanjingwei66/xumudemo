package cn.iocoder.yudao.module.cumu.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 用户相关  1004001000============
    ErrorCode CUSTOM_NOT_EXISTS = new ErrorCode(1004001000, "用户不存在");
    ErrorCode JOINER_NOT_EXISTS = new ErrorCode(1004001001, "畜牧进场不存在");
    ErrorCode LEFTER_NOT_EXISTS = new ErrorCode(1004001002, "畜牧离场不存在");
    ErrorCode ORDER_NOT_EXISTS = new ErrorCode(1004003000, "畜牧订单交易不存在");
    ErrorCode ORDER_ERROR = new ErrorCode(1004003001, "卖家畜牧数量不足请核对");
    ErrorCode INVALID_ERROR = new ErrorCode(1004003001, "无效的凭证号");
    ErrorCode SALE_ERROR = new ErrorCode(1004003001, "卖家缺少入场信息");
    ErrorCode BUY_ERROR = new ErrorCode(1004003001, "买家缺少入场信息");
    ErrorCode JOIN_ERROR = new ErrorCode(1004003001, "缺少入场信息,请刷卡办理入场");
    ErrorCode JOIN_INFO_NOT_EXISTS = new ErrorCode(1004003005, "畜牧入场详情不存在");
    ErrorCode LEFT_INFO_NOT_EXISTS = new ErrorCode(1004003006, "畜牧离场详情不存在");
    ErrorCode ORDER_INFO_NOT_EXISTS = new ErrorCode(1004004000, "畜牧订单详情不存在");
    ErrorCode JUAN_NOT_EXISTS = new ErrorCode(1004004008, "圈不存在");
    ErrorCode JUAN_EXISTS = new ErrorCode(1004004008, "圈已被占用");
    ErrorCode TEMP_JUAN_NOT_EXISTS = new ErrorCode(1004004008, "临时圈不存在");
    ErrorCode TEMP_JUAN_EXISTS = new ErrorCode(1004004008, "临时圈已被占用");
    ErrorCode NOT_LETERED = new ErrorCode(1004004008, "当前用户已离场不能修改");
