package cn.iocoder.yudao.module.cumu.dal.dataobject.joiner;
 ...
 * @author 管理员
 */
@TableName("cumu_joiner")
@KeySequence("cumu_joiner_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class JoinerDO extends BaseDO {
